class WeatherResponse {
  ...
  factory WeatherResponse.fromJson(Map<String, dynamic> json) => WeatherResponse(
        ...
        cnt: json['cnt'],
        list: List<WeatherList>.from(json['list'].map((x) => WeatherList.fromJson(x))),
...
class Rain {
  ...
  factory Rain.fromJson(Map<String, dynamic> json) => Rain(h3: (json['3h'] as num?)?.toDouble());

  Map<String, dynamic> toJson() => {'3h': h3};
}
...
class Coord {
  ...
  factory Coord.fromJson(Map<String, dynamic> json) =>
      Coord(lat: (json['lat'] as num).toDouble(), lon: (json['lon'] as num).toDouble());
